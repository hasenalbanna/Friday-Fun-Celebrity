...
export default async (req, res) => {
    ...
    if (!celebrity) {
        return res.status(400).json({ message: 'Missing celebrity data' });
    }
    ...
    try {
        ...
        if (votes[celebrity] !== undefined) {
            votes[celebrity] = (votes[celebrity] || 0) + 1;
        } else {
        ...
        await octokit.rest.repos.createOrUpdateFileContents({
            ...
            repo: GITHUB_REPO,
            path: FILE_PATH,
            message: `Updated vote for ${celebrity}`,
